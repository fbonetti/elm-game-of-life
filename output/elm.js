...
Elm.Main.make = function (_elm) {
   ...
   var liveOrDie = F3(function (startingGrid,location,value) {
      var _p2 = value;
      switch (_p2)
      {case 0: return false;
         case 1: return false;
         case 2: return false;
         case 3: return true;
         case 4: return A2($Maybe.withDefault,false,A2($Matrix.get,location,startingGrid));
   ...
   var gridHeight = 80;
   var fullSum = F3(function (grid,_p3,value) {
      var _p4 = _p3;
      var _p6 = _p4._1;
      var _p5 = _p4._0;
      var v$$ = A2($Maybe.withDefault,0,A2($Matrix.get,{ctor: "_Tuple2",_0: _p5,_1: A2($Basics._op["%"],_p6 + 1,gridHeight)},grid));
      var v$ = A2($Maybe.withDefault,0,A2($Matrix.get,{ctor: "_Tuple2",_0: _p5,_1: A2($Basics._op["%"],_p6 - 1,gridHeight)},grid));
      return value + v$ + v$$;
   });
   var gridWidth = 80;
   ...
   var partialSum = F3(function (grid,_p7,value) {
      var _p8 = _p7;
      var _p10 = _p8._1;
      var _p9 = _p8._0;
      var v$$ = A2($Maybe.withDefault,false,A2($Matrix.get,{ctor: "_Tuple2",_0: A2($Basics._op["%"],_p9 + 1,gridWidth),_1: _p10},grid));
      var v$ = A2($Maybe.withDefault,false,A2($Matrix.get,{ctor: "_Tuple2",_0: A2($Basics._op["%"],_p9 - 1,gridWidth),_1: _p10},grid));
      return (value ? 1 : 0) + (v$ ? 1 : 0) + (v$$ ? 1 : 0);
   });
   var update = F2(function (time,grid) {
      var partialSumGrid = A2($Matrix.mapWithLocation,partialSum(grid),grid);
      var fullSumGrid = A2($Matrix.mapWithLocation,fullSum(partialSumGrid),partialSumGrid);
      return A2($Matrix.mapWithLocation,liveOrDie(grid),fullSumGrid);
   });
   var cellSize = 5;
   var renderCell = function (_p11) {
      var _p12 = _p11;
      var _p15 = _p12._0;
      var y = function (_p13) {    return $Basics.toFloat($Basics.snd(_p13));}(_p15);
      var x = function (_p14) {    return $Basics.toFloat($Basics.fst(_p14));}(_p15);
      return A2($Graphics$Collage.move,
      {ctor: "_Tuple2",_0: x * cellSize - 200,_1: y * cellSize - 200},
      A2($Graphics$Collage.filled,_p12._1 ? $Color.blue : $Color.white,$Graphics$Collage.square(cellSize)));
   };
